import * as parts from "./messageParts";
import line = require('@line/bot-sdk');

export const depthOptions: line.FlexBubble = {
  "type": "bubble",
  "body": {
    "type": "box",
    "layout": "vertical",
...
export const wolfNumberMessage = async (wolfNumberOptions: number[]): Promise<line.FlexBubble> => {
  let wolfNumberMessages: line.FlexButton[] = [];
...
export const lunaticNumberMessage = async (lunaticNumberOptions: number[]): Promise<line.FlexBubble> => {
  let lunaticNumberMessages: line.FlexButton[] = [];
...
export const settingConfirmMessage = async (userNumber: number, depth: number, wolfNumber: number, lunaticNumber: number, timerString: string): Promise<line.FlexBubble> => {
