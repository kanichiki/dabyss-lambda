...
export const voteMessage = async (displayNames: string[], userIds: string[]): Promise<line.FlexBubble[]> => {
  let voteMessages: line.FlexBubble[] = [];
...
export const revoteMessage = async (displayNames: string[], userIds: string[], userIndexes: number[]): Promise<line.FlexBubble[]> => {
  let voteMessages: line.FlexBubble[] = [];
...
export const gamesMessage = async (): Promise<line.FlexCarousel> => {
  const gamesCarousel: line.FlexCarousel = {
    "type": "carousel",
    "contents": [
      {
        "type": "bubble",
