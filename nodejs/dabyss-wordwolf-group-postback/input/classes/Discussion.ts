...
export class Discussion {
    ...
    static async createInstance(gameId: number, day: number): Promise<Discussion> {
        const discussion: Discussion = new Discussion(gameId, day);
        await discussion.init();
        return discussion;
    }

    static async putDiscussion(gameId: number, day: number, timer: string): Promise<void> {
        try {
